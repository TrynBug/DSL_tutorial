...
struct lua_grammar : qi::grammar<Iterator, lua::ChunkPtr(), skipper<Iterator>> {
    lua_grammar() : lua_grammar::base_type(ruleChunk) {
        ...
        ruleTypeExpression      = ruleUnaryExpression | ruleBinaryExpression | rulePrimaryExpression;
        ...
        // rule PrimaryExpression은 기본 표현식을 의미한다. 
        ...
        // rule BinaryExpression은 이항 연산자 표현식을 의미한다. "표현식 연산자 표현식"
        ...
        // rule UnaryExpression은 단항 연산자 표현식을 의미한다. "연산자 표현식"
